...
export async function execute(sock, msg, args) {
  ...
  if (!args || args.length === 0) {
    ...
    await sock.sendMessage(from, { text: "> SIGMA MDX MD :Usage : .writetoall <message>" });
  ...
  try {
    ...
    // Envoyer le message é chaque participant
    ...
    await sock.sendMessage(from, { text: `> SIGMA MDX MD : Message envoyé é tous les membres du groupe( ${participants.length} membres.)` });
