  ...
  try {
    ...
    if (!userToWaste) {
      await sock.sendMessage(from, { 
        text: "> SIGMA MDX DEPLOY:?? Veuillez mentionner quelquéun ou répondre à son message pour utiliser la commande Wasted !" 
      }, { quoted: msg });
      return;
    }
    ...
    if (isGroup) {
      try {
        ...
        await sock.sendMessage(from, { text: "> SIGMA MDX DEPLOY:?? Impossible d'expulser l'utilisateur. Vérifiez que j'ai les droits admin !" });
      }
    }
    ...
    await sock.sendMessage(msg.key.remoteJid, {
      text: "> SIGMA MDX DEPLOY:? Impossible de créer l'image Wasted. Réessayez plus tard."
    }, { quoted: msg });
  }
}