...
export async function execute(sock, msg, args) {
  ...
  try {
    ...
    if (!data.elements || data.elements.length === 0) {
      await sock.sendMessage(from, { text: "> ❌ SIGMA MDX DEPLOY : Aucun cours trouvé." }, { quoted: msg });
      return;
    }
    
    let reply = `> ?? SIGMA MDX DEPLOY : Cours ${sujet}\n🎨🎨🎨🎨🎨🎨\n\n`;
    ...
    await sock.sendMessage(from, { text: "> SIGMA MDX DEPLOY : Service Coursera indisponible." }, { quoted: msg });
  }
}