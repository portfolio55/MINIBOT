...
export async function execute(sock, msg, args) {
    ...
    const botname = 'SIGMA MDX DEPLOY'; // Ajustez selon votre configuration

    try {
        // Message d'attente
        const sentMsg = await sock.sendMessage(from, {
            text: '⚡ *SIGMA MDX DEPLOY* - Preparing 5 images...'
        }, { quoted: msg });
        ...
        for (let i = 0; i < imageUrls.length; i++) {
            try {
                ...
                // **Délai CRITIQUE** : Attendre 1.5 é 2 secondes entre chaque envoi pour éviter
                // que WhatsApp ne considére le bot comme un spammeur et ne le bloque.
                ...
                await sock.sendMessage(from, {
                    text: `⚡ Failed to send image ${i+1}. Skipping.`
                }, { quoted: statusMsg });
            }
        }
