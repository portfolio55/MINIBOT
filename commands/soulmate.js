...
export async function execute(sock, msg, args) {
  ...
  try {
    ...
    if (participants.length < 2) {
      return await sock.sendMessage(from, { 
        text: "? *SIGMA MDX DEPLOY*: Need at least 2 members in the group"
      }, { quoted: msg });
    }
    ...
    if (otherParticipants.length === 0) {
      return await sock.sendMessage(from, { 
        text: "? *SIGMA MDX DEPLOY*: You're alone in this group ✅"
      }, { quoted: msg });
    }
    ...
    const message = `⚡ *SIGMA MDX DEPLOY - Soulmate Match* ??\n\n` +
    ...
    await sock.sendMessage(from, { 
      text: "? *SIGMA MDX DEPLOY*: Error finding soulmate\n" +
