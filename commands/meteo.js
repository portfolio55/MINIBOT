...
export async function execute(sock, msg, args) {
  try {
    ...
    if (!city) {
      await sock.sendMessage(from, { text: "> SIGMA MDX DEPLOY:? Utilisation : meteo <ville>" }, { quoted: msg });
      return;
    }
...
> ?? *Météo é ${weather.name}* ??
> -------------------
> 🎨 *Conditions* : ${weather.weather[0].description}
> 🎨 *Température* : ${weather.main.temp}ÉC ??
> 🎨 *Ressenti* : ${weather.main.feels_like}ÉC ??
> ?? *Humidité* : ${weather.main.humidity}% ??
> 🎨 *Vent* : ${weather.wind.speed} m/s ??
> ?? *Pression* : ${weather.main.pressure} hPa ??
> -------------------
> ❌ Derniére mise à jour : ${new Date(weather.dt * 1000).toLocaleTimeString("fr-FR")}
> +-----------------+`;
    ...
    await sock.sendMessage(msg.key.remoteJid, { text: "> SIGMA MDX DEPLOY:?? Désolé, je n'ai pas pu récupérer la météo pour cette ville." }, { quoted: msg });
  }
}