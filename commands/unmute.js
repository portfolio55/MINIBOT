...
export async function execute(sock, msg, args) {
  ...
  try {
    ...
    await sock.sendMessage(from, { text: "> SIGMA MDX DEPLOY : Groupe ouvert !" }, { quoted: msg });

  } catch (err) {

    console.error("Erreur lors de l'ouverture du groupe :", err);

    await sock.sendMessage(from, { text: "> SIGMA MDX DEPLOY : Impossible d'ouvrir le groupe. Assurez-vous que vous étes admin." }, { quoted: msg });
