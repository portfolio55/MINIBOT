  ...
  try {
    ...
    if (!args[0]) {
      await sock.sendMessage(from, {
        text: `> SIGMA MDX DEPLOY: ?? Veuillez fournir le lien du pack Telegram.\n\n> Exemple : .tg https://t.me/addstickers/Porcientoreal`
      }, { quoted: msg });
      return;
    }
    ...
    // Token Telegram (?? é remplacer par le tien)
    ...
    for (let i = 0; i < stickers.length; i++) {
      try {
        ...
        const metadata = {
          ...
          "sticker-pack-publisher": "SIGMA MDX DEPLOY",
...
> +---- CONVERSION TERMINéE ----+
> ❌ Pack : ${data.result.title}
> ❌ Succés : ${success}/${stickers.length}
> ❌ Statut : ? Terminé
> +--------------------------+`
    }, { quoted: msg });
