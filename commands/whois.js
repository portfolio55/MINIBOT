...
export async function execute(sock, msg, args) {
  ...
  try {
    ...
    // Texte SIGMA MDX MDX V2

    let whoisText = `> SIGMA MDX DEPLOY :
...
`;
    ...
    console.error("> SIGMA MDX MD : ? Erreur whois :", err);

    await sock.sendMessage(from, { text: "> SIGMA MDX MD : Erreur whois." }, { quoted: msg });
